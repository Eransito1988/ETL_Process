...
select *, INVOICE_NUM,right(PHONE_NO,7) 'Number', case when PHONE_NO like '+___%' then SUBSTRING(PHONE_NO,2,3) end 'Prefix country', case when  PHONE_NO like '+___%' then SUBSTRING(PHONE_NO,5,2) end 'Prefix Operation'
